...
class CrosslinksSystemSettingsUpdateProcessor extends modSystemSettingsUpdateProcessor
{
    ...
    public $languageTopics = array('setting', 'namespace', 'crosslinks:default');
    ...
    protected function checkCanSave()
    {
        ...
        if (!($this->modx->user->isMember('Administrator') || $this->modx->user->isMember('Crosslinks Administrator'))) {
