...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            if ($oldPackage && $oldPackage->compareVersion('1.3.0', '>')) {
                $cleanup = [
                    'core' => [
                        'components/crosslinks/model/crosslinks/events',
                    ]
                ];
                cleanupFolders($modx, $corePath, $assetsPath, $cleanup, 'Crosslinks', '1.3.0');
            }
            $success = true;
            break;
